#taken and modified from: https://github.com/jaiwei98/MobileNetV4-pytorch/blob/main/mobilenet/mobilenetv4.py
...
class MobileNetV4(nn.Module):
    def __init__(self, model, iCls: int = 10):
        ...
        self.head = torch.nn.Linear(1280, iCls)
...
if __name__ == "__main__":
    tModel = MobileNetV4("MobileNetV4ConvSmall")
